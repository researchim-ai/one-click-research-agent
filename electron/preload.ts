...
contextBridge.exposeInMainWorld('api', {
  ...
  listPrompts: (): Promise<any[]> => ipcRenderer.invoke('list-prompts'),
  savePrompt: (id: string, text: string | null): Promise<any[]> => ipcRenderer.invoke('save-prompt', { id, text }),
  resetPrompt: (id: string): Promise<any[]> => ipcRenderer.invoke('reset-prompt', { id }),
  resetAllPrompts: (): Promise<any[]> => ipcRenderer.invoke('reset-all-prompts'),
  openPromptsDir: (): Promise<string> => ipcRenderer.invoke('open-prompts-dir'),
