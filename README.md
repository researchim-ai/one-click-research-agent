...
Это не «ещё один чат с LLM», а локальный агентный runtime. Помимо обычной агентной работы (чтение и правка файлов, запуск команд, поиск), его флагманская функция — управляемый **deep research**, который умеет:
