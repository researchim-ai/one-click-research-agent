...
export const RESEARCH_PROFILES: ResearchProfile[] = [
  ...
  },
  {
    ...
    preferredTools: ['search_pubmed', 'search_biorxiv', 'search_openalex', 'search_crossref', 'search_arxiv', 'smart_search', 'fetch_url', 'parse_document', 'record_evidence'],
    sourceConnectors: [
      { id: 'pubmed', label: 'PubMed / Europe PMC', description: 'Biomedical literature and abstracts — primary source for clinical/medical topics.', preferredTools: ['search_pubmed'], status: 'available' },
      { id: 'pmc-fulltext', label: 'PMC full text', description: 'Open-access biomedical full text.', preferredTools: ['fetch_url'], status: 'planned' },
      { id: 'arxiv-qbio', label: 'arXiv (q-bio / biophysics)', description: 'Preprints in quantitative biology, biophysics and computational biomedicine. Complements PubMed; note arXiv does NOT index clinical trials or medical journal articles.', preferredTools: ['search_arxiv'], status: 'available' },
      { id: 'biorxiv-medrxiv', label: 'bioRxiv / medRxiv', description: 'Life-science and clinical preprints (newest, often open-access). Search via search_biorxiv.', preferredTools: ['search_biorxiv'], status: 'available' },
