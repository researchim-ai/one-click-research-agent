...
export const RESEARCH_PROFILES: ResearchProfile[] = [
  {
    ...
    domain: 'general',
    description: 'Универсальный профиль для open-ended research, документов, web, репозиториев и смешанных задач.',
    preferredTools: ['smart_search', 'fetch_url', 'plan_research', 'reflect', 'verify_sources', 'record_evidence', 'run_quality_gates'],
    sourceConnectors: [
      { id: 'openalex', label: 'OpenAlex', description: 'Общий академический граф и metadata.', preferredTools: ['search_openalex'], status: 'available' },
      { id: 'crossref', label: 'Crossref', description: 'DOI-grade bibliographic metadata.', preferredTools: ['search_crossref'], status: 'available' },
      { id: 'searxng', label: 'SearXNG', description: 'Широкий web search по docs/repos/news.', preferredTools: ['search_web'], status: 'available' },
    ],
